export const my_blogs = {
  ...
  blog_2: {
    ...
    date: "2022-01-24",
    content:
      "Hey there ,I was one of the few people who joined StackUp when it was in Beta. StackUp has been since then a great source of information for me, the platform itself is awesome and also the stackup community on discord is pretty awesome, which helped me solved many doubts not only related to quests also from my personal projects. Stackup motivates me to learn new things because it offers rewards on each milestone you completely which is pretty awesome. In past 4 months there has been a lot of campaigns (such as MySQL, Firebase, GitOps and Cyber Security) which were very beneficial in my web development journey.",
  },
};
